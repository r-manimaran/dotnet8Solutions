...
namespace Orders.Api.Migrations
{
    ...
    [Migration("20250103154403_Create-Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orders.Api.Models.WebhookDeliveryAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orders.Api.Models.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orders.Api.Models.WebhookDeliveryAttempt", b =>
                {
                    b.HasOne("Orders.Api.Models.WebhookSubscription", null)
                        .WithMany()
